...
import io.github.artiship.arlo.enums.OSInfo;
...
//             killLinuxProcess(3l); 
            int pid = 65633;
            TaskProcessUtils.execCommand("/Users/admin/arlo/arlo-scheduler/scheduler-worker/src/script/kill.sh",
